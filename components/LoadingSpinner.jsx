...
const LoadingSpinner = () => {
  return (
    <StyledWrapper >
      <svg style={{left: '50%', top: '50%', position: '', transfjorm: 'translate(-50%, -50%) matrix(1, 0, 0, 1, 0, 0)'}} preserveAspectRatio="xMidYMid meet" viewBox="0 0 187.3 93.7" height="300px" width="400px">
